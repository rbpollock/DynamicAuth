...
const createEmbeddedWalletWithPasskey = ({ user, walletConnector, environmentId, authToken, }) => __awaiter(void 0, void 0, void 0, function* () {
    if (!authToken) {
...
export { createEmbeddedWalletWithPasskey };
