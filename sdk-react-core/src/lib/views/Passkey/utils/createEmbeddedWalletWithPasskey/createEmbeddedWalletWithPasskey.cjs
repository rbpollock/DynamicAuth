...
const createEmbeddedWalletWithPasskey = ({ user, walletConnector, environmentId, authToken, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    if (!authToken) {
    ...
    const { attestation, challenge } = yield walletConnector.getWebAuthnAttestation();
...
exports.createEmbeddedWalletWithPasskey = createEmbeddedWalletWithPasskey;
