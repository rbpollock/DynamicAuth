...
const Typography = (_a) => {
    var { as: Tag = 'p', variant, weight, color, transform, className = '', truncate = false } = _a, props = _tslib.__rest(_a, ["as", "variant", "weight", "color", "transform", "className", "truncate"]);
    ...
    return jsxRuntime.jsx(Tag, Object.assign({ className: effectiveClassName }, props));
};
