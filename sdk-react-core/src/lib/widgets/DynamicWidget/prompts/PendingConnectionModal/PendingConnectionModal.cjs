...
const PendingConnectionModal = () => {
    ...
    return (jsxRuntime.jsx(DefaultPromptModal.DefaultPromptModal, { showCloseButton: true, dataTestId: 'pending-connection-modal', icon: jsxRuntime.jsx(AuthProviderIcon.AuthProviderIcon // eslint-disable-line
