...
const useAwaitingAccountSwitch = () => {
    const [accountSwitchState, setInternalAccountSwitchState] = React.useState('idle');
    const resetState = React.useCallback(() => {
        setInternalAccountSwitchState('idle');
    }, [setInternalAccountSwitchState]);
    const setAccountSwitchState = React.useCallback((newAccountSwitchState, widgetState) => {
...
exports.useAwaitingAccountSwitch = useAwaitingAccountSwitch;
