 ...
 */
const useTransactionEstimatedGas = (provider, transaction) => usePromise.usePromise(() => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    const { from } = transaction, transactionWithoutFrom = _tslib.__rest(transaction, ["from"]);
    return provider.estimateGas(Object.assign(Object.assign({}, transactionWithoutFrom), { account: from }));
}), {
    deps: [transaction, provider],
});

exports.useTransactionEstimatedGas = useTransactionEstimatedGas;
